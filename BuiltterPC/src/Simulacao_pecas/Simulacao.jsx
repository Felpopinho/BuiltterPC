...
export function Simulacao(){
    ...
    return <div className="simulacao_container" id="Simulacao">
        ...
        <Box className="moldeBox" sx={{display: "flex", alignItems: "center", height: "40vh", width: "75%", overflowX: 'scroll', alignSelf:"center", borderRadius: "10px", backgroundColor: "lightgray"}}>
